    ...
    <main className="flex-1 w-full bg-[var(--bg)] text-[var(--fg-muted)] px-4 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="mt-3 text-sm leading-relaxed">
            理由の如何を問わず、ユーザーが本サービスを利用する権利を失った場合、本サービスの一切のコンテンツの利用ができなくなることを、ユーザーはあらかじめ承諾するものとします。
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mt-3 text-sm leading-relaxed">
            ユーザーの投稿に関する著作権は、ユーザー自身に留保されます。当社はユーザーの投稿に関して著作権を取得することはありません。ただし、当社は、本サービスの提供、維持、改善に必要な範囲において、無償、無期限かつ地域非限定で、ユーザーの投稿を複製、翻案、自動公衆送信およびそのために必要な送信可能化をすることができるものとします。この場合、ユーザーは、当社および当社から権利を承継しまたは許諾された者に対し著作者人格権を行使しないものとします。
            当社は、ユーザーの投稿（音声日記・対話記録）を、当社または第三者による AI
            モデルの学習には使用しません。
          </p>
          <p className="mt-3 text-sm leading-relaxed">

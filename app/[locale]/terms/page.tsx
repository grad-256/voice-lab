    ...
    <main className="flex-1 w-full bg-[var(--bg)] text-[var(--fg-muted)] px-4 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-[var(--fg)] mb-3">1. サービスの概要</h2>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-[var(--fg)] mb-3">2. 禁止事項</h2>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-[var(--fg)] mb-3">3. 免責事項</h2>
          <ul className="mt-3 space-y-2 text-sm list-disc list-inside">
            <li>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-[var(--fg)] mb-3">4. サービスの変更・終了</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-[var(--fg)] mb-3">5. 規約の変更</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-[var(--fg)] mb-3">6. 準拠法・管轄裁判所</h2>
          <p className="text-sm leading-relaxed">
            本規約は日本法に準拠します。
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-[var(--fg)] mb-3">7. お問い合わせ</h2>
          <p className="text-sm leading-relaxed">
